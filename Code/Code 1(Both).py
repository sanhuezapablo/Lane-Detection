...
#        cv2.rectangle(mask, (0, 300), (1500, 740), (255, 255, 255), -1)
#        maskedImg = cv2.bitwise_and(warped, mask)
        ...
        for i in range(0,len(x)):
            if x[i]<xl_max[0] and x[i]>xl_min[0] and x[i]<270:
                
                x_left.append(x[i])
                y_left.append(y[i])
                       
            if x[i]>xr_min[0] and x[i]<xr_max[0] and x[i]>410:
